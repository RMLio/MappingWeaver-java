...
public class RMLIOCorePostgreSQLTest extends DBTestCore {
    ...
    public void positiveTest(String directory) throws Exception {
        ...
        String resourceFile = "src/test/resources/rmlio/spec/core/" + directory + "/resource.sql";
