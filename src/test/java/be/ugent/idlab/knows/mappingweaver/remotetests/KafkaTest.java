...
public class KafkaTest extends TestCore {
    ...
    public void csvTest() throws Exception {
        ...
        MappingPlan plan = MappingPlan.fromString(env, planJson, "src/test/resources/kafka/csv", "http://example.com/", false);
    ...
    public void jsonTest() throws Exception {
        ...
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        MappingPlan plan = MappingPlan.fromString(env, planJson, "src/test/resources/kafka/json", "http://example.com/", false);
        SourceOperator op = (SourceOperator) plan.getOperatorGraph().getOperators().getFirst();
        runKafkaTest(op);
    }
    ...
    public void xmlTest() throws Exception {
        ...
        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
        MappingPlan plan = MappingPlan.fromString(env, planJson, "src/test/resources/kafka/xml", "http://example.com/", false);
        SourceOperator op = (SourceOperator) plan.getOperatorGraph().getOperators().getFirst();
        runKafkaTest(op);
    }
